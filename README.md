...
| gesamtleistungKomplettInEuro                                          | Dezimalzahl  | Summe aller Zahlungen in der Darlehensphase                                                                                                                       |
...
| bausparDarlehen.tilgungsPlan.zahlungen[].gebuehrenInEuro              | Dezimalzahl  |                                                                                                                                                                   |
| bausparDarlehen.tilgungsPlan.zahlungen[].kontofuehrungsGebuehrInEuro  | Dezimalzahl  |                                                                                                                                                                   |
| bausparDarlehen.tilgungsPlan.zahlungen[].saldoNachZahlungInEuro       | Dezimalzahl  |                                                                                                                                                                   |
| bausparDarlehen.tilgungsPlan.zahlungen[].tilgungInEuro                | Dezimalzahl  |                                                                                                                                                                   |
| bausparDarlehen.tilgungsPlan.zahlungen[].zahlungInEuro                | Dezimalzahl  |                                                                                                                                                                   |
| bausparDarlehen.tilgungsPlan.zahlungen[].zinsInEuro                   | Dezimalzahl  |                                                                                                                                                                   |
...
| sparPhase.sparPlan.zahlungen[].datum                                  | Datum        |                                                                                                                                                                   |
| sparPhase.sparPlan.zahlungen[].gebuehrenInEuro                        | Dezimalzahl  |                                                                                                                                                                   |
| sparPhase.sparPlan.zahlungen[].kontofuehrungsGebuehrInEuro            | Dezimalzahl  |                                                                                                                                                                   |
| sparPhase.sparPlan.zahlungen[].saldoNachZahlungInEuro                 | Dezimalzahl  |                                                                                                                                                                   |
| sparPhase.sparPlan.zahlungen[].zahlungInEuro                          | Dezimalzahl  | Die Sparrate                                                                                                                                                      |
| sparPhase.sparPlan.zahlungen[].zinsInEuro                             | Dezimalzahl  | Der Betrag an Guthabenzinsen der zu diesem Datum mit dem Bausparvertrag verrechnet wird.                                                                          |
...
| antragsteller[0].titel.doktor                                         | Boolean                | Doktor                                                                                                                                                                        |
| antragsteller[0].titel.professor                                      | Boolean                | Professor                                                                                                                                                                        |
...
| antragsteller[0].zahlungsDaten.zahlungsForm                           | Aufzählung             | Mögliche Werte sind: ``LASTSCHRIFT``, ``UEBERWEISUNG``. Aktuell wird nur ``LASTSCHRIFT`` verwendet.                                                                                                                      |
...
| antragsteller[0].vermoegenswirksameLeistungenBetragInEuro             | Dezimalzahl            | Der Betrag der vermögenswirksamen Leistungen, die der Arbeitgeber des Antragstellers in diesen Bausparvertrag einzahlt. Es werden immer die VL Beträge aller Antragsteller eingezahlt. Dieses Feld ist noch nicht im Frontend enthalten.|
